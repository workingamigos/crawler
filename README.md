...
http://www.simplyhired.com/k-remote-web-developer-jobs.html `jobs` `freelance` `remote` `cool` `javascript`

https://twitter.com/search?q=%23remotejob%20%23javascript&src=typd `jobs` `freelance` `remote` `cool` `javascript`

https://twitter.com/remotees `jobs` `freelance` `remote` `cool` `javascript`
...
https://www.reddit.com/r/javascript_jobs/ `freelance` `remote` `cool` `javascript`

https://stackoverflow.com/jobs?searchTerm=javascript&allowsremote=true `remote` `jobs` `cool`

https://jobs.github.com/positions?description=JavaScript `remote` `jobs` `cool`
...
http://teamtreehouse.com/jobs
http://frontenddeveloperjob.com/
http://jobs.nodejs.org/
http://www.angularjobs.com/
